...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Dhii719/mini/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/Dhii719/izin/main/ip"
# USERNAME
rm -f /usr/bin/user
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/6285226487011"}]]}' 
...
wget -q https://raw.githubusercontent.com/Dhii719/mini/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
